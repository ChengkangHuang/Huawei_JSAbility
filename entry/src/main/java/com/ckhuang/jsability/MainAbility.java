...
import com.ckhuang.jsability.widget.controller.FormController;
import com.ckhuang.jsability.widget.controller.FormControllerManager;
...
public class MainAbility extends AceAbility {
    ...
    private void requestPermissions() {
        if (verifySelfPermission(SystemPermission.INTERNET) != 0) {
